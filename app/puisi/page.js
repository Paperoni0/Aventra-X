...
export default function PoemPage() {
    ...
    return (
        ...
        .banner::after { content: ''; position: absolute; inset: 0; background: linear-gradient(to bottom, rgba(0,0,0,0) 0%, rgba(10,31,10,0.15) 50%, rgba(10,31,10,1) 100%); z-index: 2; }
